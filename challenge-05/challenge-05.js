...
array criado.
*/
console.log(arrPosition(arrTypes, 0));
console.log(arrPosition(arrTypes, 1));
console.log(arrPosition(arrTypes, 2));
console.log(arrPosition(arrTypes, 3));
console.log(arrPosition(arrTypes, 4));
