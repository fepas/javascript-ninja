...
*/
console.log(pessoa.nomeCompleto()); // 'Olá, meu nome é Felipe Campos'
...
inline ao lado da instrução para mostrar qual foi a resposta retornada)
*/
console.log(pessoa.mostrarPeso()); //'Eu peso 90Kg'

/*
Qual a altura da pessoa? (Use a instrução para responder e comentários
inline ao lado da instrução para mostrar qual foi a resposta retornada)
*/
console.log(pessoa.mostrarAltura()); //'Minha altura é 1.78m' 90Kg'
