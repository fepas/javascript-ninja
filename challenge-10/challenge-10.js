(function() {
  ...
  /*
    ...
    */
    var operationSignal = '^';
    var wrongSignal = calculator(operationSignal);

    if(wrongSignal( number1, number2)) {
        console.log(showOperationMessage( operationSignal, number1, number2 ), wrongSignal( number1, number2 ));
    }
    else{
        console.log(showErrorMessage(operationSignal));
    }
